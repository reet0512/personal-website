        ...
        <section id="bio-section">
            ...
            <div id="bio-content">
                <div id = "bio-para">
                    ...
                    <div id="icon-info">
                        <i class="fa-solid fa-headphones fa-xl"></i> Rock
                        <br/>
                        <i class="fa-solid fa-chess-board fa-xl"></i> Blitz: 1424
                        <br/>
                        <i class="fa-solid fa-gamepad fa-xl"></i> Rocket League, Fortnite, CS:GO
                        <br/>
                        <i class="fa-solid fa-language fa-xl"></i> English, Hindi, Marwari
                    </div>
                </div>
                <div id = "bio-pic">
                    <img
